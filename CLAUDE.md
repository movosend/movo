...
- **ADRs con desarrollo completo pendiente de pegar en Drive** (solo tienen el resumen
  ...
  procedimiento que ADR-022. Ojo con la numeración: el doc de Sprint 0 ya usa ADR-025
  para el pricing dinámico (MOVO-216, todavía en su rama spike), por eso este es 026.
